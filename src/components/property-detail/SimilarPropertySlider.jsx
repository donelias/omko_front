        ...
        <>
          ...
          <div className="grid grid-cols-12 gap-6">
            ...
            <div className="col-span-12 md:col-span-12 lg:col-span-3 ">
              <div className="cardBg newBorder flex h-full max-h-[420px] lg:max-h-[420px] xl:max-h-[400px] 2xl:max-h-[450px] flex-col items-center rounded-2xl p-4 md:p-6 text-center">
