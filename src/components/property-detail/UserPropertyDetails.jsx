      ...
      <div className="bg-white">
        <div className="container mx-auto px-3 pt-8">
          <div className="grid grid-cols-12 gap-3">
            {/* Property Gallery */}
            <div className={`col-span-12 h-full w-full rounded-lg ${(propertyDetails?.request_status === "draft" || propertyDetails?.request_status === "pending") && !belowMortgageAdBanner ? 'lg:col-span-12' : 'lg:col-span-9'}`}>
              {/* About Property */}
