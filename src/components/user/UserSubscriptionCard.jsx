...
const UserSubscriptionCard = ({
    ...
    const projectList = getFeatureLimit(subscriptionData.features, 2);
    const propertyFeatureList = getFeatureLimit(subscriptionData.features, 3);
        ...
        <motion.div ref={cardRef}>
            <div className="border border-[#e7e7e7] border-solid flex flex-col gap-4 items-start justify-center overflow-clip p-4 relative rounded-2xl w-full bg-white">
                <div className="bg-white flex flex-col gap-4 w-full relative">
                    ...
                    {/* Header */}
                    <div className="bg-[#181818] flex items-center justify-between overflow-clip pl-4 pr-16 md:pr-24 py-4 rounded-lg relative w-full">
