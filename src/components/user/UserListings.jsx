    ...
    const desktopTableColumns = [
        ...
        },
        {
            ...
            renderCell: (item) => (
                <div className="flex items-center justify-center gap-1">
                    ...
                    />
                    <span className={`text-sm ${item.statusActive ? "primaryColor" : "secondaryTextColor"} capitalize`}>
        ...
        },
        {
            ...
            renderCell: (item) => {
                ...
                return <span className="text-sm font-medium secondaryTextColor text-nowrap">{label}</span>;
            },
        },
        {
            header: t("action"),
