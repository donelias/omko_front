...
const NewUserDashboard = () => {
    ...
    }, [filters.propertyProject, filters.propertyProjectTab, lang]);

    useEffect(() => {
        fetchDashboardMostViewedCategory();
    }, [filters.categoryView, lang]);

    useEffect(() => {
        fetchDashboardMostViewedListing();
    }, [filters.mostViewed, filters.mostViewedTab, lang]);

    useEffect(() => {
        fetchDashboardAppointments();
    }, [filters.appointments, appointmentCurrentPage, lang]);
