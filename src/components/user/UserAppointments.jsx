...
const UserAppointments = () => {
    ...
    const appointmentsQuery = useQuery({
        queryKey: ["userAppointments", activeTab, currentPage, itemsPerPage],
        queryFn: async () => {
    ...
    return (
        <div className="flex flex-col rounded-xl md:rounded-2xl border w-full newBorderColor bg-white overflow-hidden">
            ...
            <div className="flex flex-wrap gap-2 items-center md:justify-between justify-center p-4 border-b brandColor">
                ...
                <div className="flex primaryBackgroundBg border newBorderColor rounded-lg p-2 gap-2">
                    <button
                        type="button"
                        onClick={() => handleTabChange("upcoming")}
                        className={`px-3 py-2 text-base font-medium rounded-lg transition-colors ${activeTab === "upcoming"
                    ...
                    <button
                        ...
                        className={`px-3 py-2 text-base font-medium rounded-lg transition-colors ${activeTab === "previous"
                            ? "primaryBg text-white"
                            : "text-gray-600 hover:text-gray-900 hover:bg-white"
                            }`}
                    >
