...
import { truncate, handlePackageCheck, isDemoMode, renderStatusBadge, RejectionTooltip, isRTL } from "@/utils/helperFunction";
...
const UserProjects = () => {
    ...
    const fetchUserProjects = async () => {
        setIsLoading(true);
        try {
            const res = await getUserProjectsApi({ limit: limit.toString(), offset: offset.toString(), type: projectTypeFilter, request_status: statusFilter });
