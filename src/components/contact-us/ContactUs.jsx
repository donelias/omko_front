...
import { BiListCheck, BiMailSend, BiMessageEdit, BiPhone } from "react-icons/bi";
...
const ContactUs = () => {
  ...
  const inputFields = [
    ...
    },
    {
      ...
      colSpan: "md:col-span-1",
      required: false,
      icon: <BiPhone className="leadColor text-xl" />,
    },
    {
      name: "subject",
      label: "subject",
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      trackEvent('generate_lead', { lead_source: 'form' }, { clarity: true });
