      ...
      {tooltipData && hoveredBar !== null && (
        <div
          ...
          style={{
            ...
            ...(isRtl ? { right: `calc(${(hoveredBar / chartValues.length) * 100}% - 100px)` } : { left: `${(hoveredBar / chartValues.length) * 100}%` }),
            transform: 'translateX(-50%)',
            minWidth: '120px'
          }}
        >
          <div className="text-sm font-semibold text-black primaryBackgroundBg border-b border-gray-200 p-2 rounded-t-lg">
            {tooltipData?.month}
          </div>
