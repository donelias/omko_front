...
const HOMEPAGE_FRESHNESS_OPTIONS = {
    staleTime: 60 * 1000,
...
const Home = () => {
    ...
    const exploreAllCategoriesLink = "/all/categories" + (isHomepageDataAvailable ? "?latitude=" + homepageLocationParams.latitude + "&longitude=" + homepageLocationParams.longitude + "&range=" + homepageLocationParams.radius + "&lang=" + activeLanguage : "?lang=" + activeLanguage);
    ...
    return (
        <section className="">
            ...
            {addBannersQuery.isLoading ? (
                <div className="container mx-auto mt-12 mb-4 px-2 lg:px-0">
                ...
                <div
                    className="container mx-auto mt-12 mb-4 px-2 lg:px-0 max-h-[350px] aspect-[1920/350]"
                    onClick={() => {
