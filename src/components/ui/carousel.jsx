...
const CarouselContent = React.forwardRef(({ className, containerClassName, ...props }, ref) => {
  ...
  return (
    (<div ref={carouselRef} className={cn("overflow-hidden md:py-4", containerClassName)}>
      <div
        ref={ref}
        className={cn(
          "flex",
  ...
  return (
    (<div
      ...
      className={cn(
        ...
        orientation === "horizontal" ? "pl-4 lg:pl-6" : "pt-4",
        className
      )}
      {...props} />)
  );
...
const CarouselDots = React.forwardRef(({ className, inactiveDotClassName = "bg-gray-100 opacity-50" }, ref) => {
