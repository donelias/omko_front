...
// Skeleton for most viewed properties section - matches HomeNewSectionTwo layout
const MostViewedSkeleton = () => {
    return (
        <div className="bg-white h-[709px] md:h-[739px]">
                ...
                <div className="flex flex-col gap-6 md:gap-12">
                    ...
                    <div className="flex flex-col md:flex-row items-center justify-center md:justify-between gap-4 md:gap-12">
                        ...
                        <div className="flex flex-col items-center md:items-start gap-2">
                            ...
                            <Skeleton className="h-6 md:h-9 w-56 md:w-64" />
                        </div>
                        {/* Button skeleton - hidden on mobile */}
                        <Skeleton className="hidden md:block h-12 w-52 rounded-lg shrink-0" />
                    </div>
