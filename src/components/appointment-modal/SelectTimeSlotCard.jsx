                        ...
                        timeSlots && timeSlots.length > 0 ? (
                            <div className="grid grid-cols-2 gap-3 min-h-min pb-2">
                                {timeSlots.map((slot) => (
                                    ...
                                    >
                                        <span className={`text-sm font-medium ${selectedTimeSlot?.id === slot.id ? 'primaryTextColor' : 'secondaryTextColor'}`}>
                                            {slot.time}
                                        </span>
                                    </button>
                                ))}
                            ...
                            <div className="text-center p-8">
                                <p className="text-base secondaryTextColor mb-2">{t("noAvailableTimeSlots")}</p>
