  ...
  return (
    ...
    >
      ...
      <header className="px-4">
        ...
        <div
          className="secondaryTextColor mt-4 overflow-hidden text-ellipsis text-sm leading-6 line-clamp-1"
      ...
      <footer className="flex items-center space-x-4 p-4">
        ...
        <div>
          ...
          <time className="secondaryTextColor text-sm" dateTime={item?.created_at}>
