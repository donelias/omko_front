      ...
      <div className="absolute bottom-0 left-0 right-0 z-10 flex h-full flex-col items-center justify-between gap-4">
        ...
        <div className="flex flex-col gap-2 p-4 md:p-4 lg:p-3 xl:p-5">
          <button
            ...
            className="secondaryTextColor rounded-lg bg-white px-4 py-2 text-base font-medium shadow-lg transition-colors duration-300 hover:bg-gray-100 md:text-lg"
          >
            {t("subscribeNow")}
          </button>
