...
const PremiumPropertyCard = ({ property, type = "" }) => {
    ...
    return (
        <div className="relative rounded-2xl overflow-hidden h-full p-4 bg-white hover:cursor-pointer" onClick={handleClick}>
            ...
            <div className="w-full h-full">
                <div className='relative w-full h-full rounded-2xl overflow-hidden'>
                    <ImageWithPlaceholder
                        ...
                        className={`w-full h-full min-h-[524px] object-cover ${getClipPathClass()} `}
                    />
