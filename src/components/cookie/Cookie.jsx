...
const CookieComponent = () => {
    ...
    return (
        <div className='fixed bottom-1 right-1 md:bottom-5 md:right-5 sm:bottom-[10px] sm:right-[10px] z-[999] 
            ...
            w-[280px] h-[350px] p-3 
            sm:w-[330px] sm:h-[330px] sm:px-4 sm:py-4
            md:w-[450px] md:h-[400px] md:p-5
            lg:w-[470px] lg:h-[340px]
            xl:w-[470px] xl:h-[335px]
            will-change-transform'>
            <div className="imgWrapper w-[80px] h-[80px] relative flex-shrink-0">
                <Image src={cookiesIcon} alt='cookiesImg' fill className="object-contain" priority />
            </div>
            ...
            <div className="btnsWrapper flex items-center justify-center gap-2 md:gap-5 mt-0 sm:mt-0 md:mt-3 lg:mt-6 pb-2 md:pb-5">
                <button
                    onClick={handleDecline}
                    className='btnBorder text-sm md:text-base bg-transparent rounded-sm p-2 md:px-5 md:py-2 font-semibold'>
                    {t("declineCookies")}
                </button>
                <button
                    onClick={handleAccept}
                    className='primaryBg text-sm md:text-base text-white p-2 md:px-5 md:py-2 rounded-sm font-semibold'>
                    {t("acceptCookies")}
                </button>
            </div>
        </div>
