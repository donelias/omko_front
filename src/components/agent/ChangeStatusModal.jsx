        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="sm:max-w-md [&>button]:hidden p-0">
                ...
                <div className="flex items-center justify-between gap-8 p-5 mx-auto">
                    {propertyType === "sell" ? (
                        <>
                            <div className="primaryTextColor primaryBg px-7 py-2.5 rounded-lg text-base">
                                {t("sell")}
                            </div>
                            <FaAngleDoubleRight size={25} className="text-black rtl:rotate-180" />
                            <div className="primaryTextColor primaryBg px-7 py-2.5 rounded-lg text-base">
                                {t("sold")}
                            </div>
                        </>
                ...
                <div className="p-4 flex justify-between sm:justify-between">
                    <DialogClose asChild>
                        <button className="border border-black p-2.5 w-1/2 m-1 rounded-md text-base">
                            {t("cancel")}
                        </button>
                    </DialogClose>
                    <button
                        className="primaryBg text-white p-2.5 w-1/2 m-1 rounded-md text-base"
