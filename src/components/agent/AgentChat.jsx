...
const AgentChat = ({
  ...
  return (
    <div className={`flex w-full h-[700px] min-h-[90%] flex-col ${showRoundedBorders ? "rounded-xl md:rounded-2xl newBorder" : ""}`}>
      ...
      <div>
        <h1 className={`secondaryTextColor pb-4 pt-2 text-2xl font-semibold ${showRoundedBorders ? "px-4 border-b newBorderColor bg-white rounded-t-xl" : ""}`}>
          {t("messages")}
        </h1>
      </div>
                      ...
                      <div className="flex w-full flex-row gap-2 md:gap-3 md:hidden">
                        ...
                        <div className="flex justify-center gap-2">
                          ...
                          <Button
                            ...
                            variant="outline"
                            className={`secondaryTextColor hover:brandBg border border-black hover:text-white h-10 ${recording ? "bg-red-600 text-white" : ""}`}
                          >
                      ...
                      <div className="hidden w-full gap-3 md:flex md:flex-row md:items-center">
                        ...
                        <div className="flex justify-center gap-2">
                          <Button
                            ...
                            onClick={toggleRecording}
                            variant="outline"
                            className={`secondaryTextColor h-10 w-10 ${recording ? "primaryBg text-white" : ""}`}
                          >
                            <BsMic className="h-5 w-5" />
                          </Button>
                          <button
