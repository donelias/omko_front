...
const AgentPersonalizedFeed = () => {
  ...
  const handleLocationSelect = (placeData, placeDetails) => {
    ...
    const latitude = Number.isFinite(placeData?.latitude) ? placeData.latitude : "";
    const longitude = Number.isFinite(placeData?.longitude) ? placeData.longitude : "";
...
export default AgentPersonalizedFeed;
