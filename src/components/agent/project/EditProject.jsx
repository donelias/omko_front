...
import { generateAIPropertyDescriptionApi, generateAIPropertyMetaDataApi, getProjectDetailsApi, getUserProjectsApi, postProjectApi, activateListingApi } from '@/api/apiRoutes'
    ...
    const handleFetchProjectDetails = async () => {
        try {
            ...
            if (!response.error) {
                ...
                setListingRequestStatus(projectData.request_status || "");
    ...
    return (
        ...
        >
            ...
            {activeTab === "seoSettings" && (
                <SEODetailsTab
                    showLoader={showLoader}
                    handleSubmit={listingRequestStatus === "draft" ? handleActivateProject : () => handleUpdateProject()}
                    ...
                    submitButtonText={listingRequestStatus === "draft" ? t("activateProject") : t("updateProject")}
                />
            )}
        </PropertyFormShell>
    )
