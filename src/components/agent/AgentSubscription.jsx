...
const AgentSubscription = ({ isUser = false }) => {
    ...
    const AnimatedCard = ({ subscriptionData, index, totalCards }) => {
        ...
        const projectList = getFeatureLimit(subscriptionData.features, 3); // Project List
        const propertyFeatureList = getFeatureLimit(subscriptionData.features, 2); // Property Feature List
        const projectFeatureList = getFeatureLimit(subscriptionData.features, 4); // Project Feature List
                ...
                <Card className="relative overflow-hidden border-0 bg-white">
                    ...
                    <CardContent className="space-y-3 sm:space-y-4 px-4 sm:px-6 pt-3 sm:pt-4 pb-4 sm:pb-6">
                        ...
                        <div className="grid grid-cols-1 xl:grid-cols-2 gap-3 sm:gap-4">
                            {/* Listing Usage */}
                            <Card className="primaryBackgroundBg border-0 shadow-none rounded-md">
                                    ...
                                    allFeatures
                                        ...
                                        .map((benefit) => {
                                            ...
                                            return (
                                                <div
                                                    key={benefit.id}
                                                    className="flex items-start p-2 sm:p-4 primaryBackgroundBg rounded-md gap-2"
                                                >
                                                    {isIncluded ? (
