...
import { getCategoriesApi, getFacilitiesApi, getAddedPropertiesApi, updatePostPropertyApi, generateAIPropertyDescriptionApi, generateAIPropertyMetaDataApi } from '@/api/apiRoutes';
