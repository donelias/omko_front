    ...
    return (
        <>
            ...
            <PaymentSelectionModalWrapper
                ...
                onPaymentSuccess={() => router.push(router?.asPath?.includes("/user/") ? `/user/listings?tab=properties&lang=${lang}` : `/agent/properties?lang=${lang}`)}
                onPaymentFailed={() => router.push(router?.asPath?.includes("/user/") ? `/user/listings?tab=properties&lang=${lang}` : `/agent/properties?lang=${lang}`)}
            />
        </>
    );
};
