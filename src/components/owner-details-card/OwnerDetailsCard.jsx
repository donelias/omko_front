...
const OwnerDetailsCard = ({
  ...
  if (isAgentOwner) {
    ...
    mobile =
      agentProfile?.agent_mobile && agentProfile?.agent_mobile !== "null"
        ? agentProfile?.agent_mobile
        : null;
        ...
        {userCurrentId !== added_by && (
          <div className="flex justify-center gap-3">
            ...
            {isAgentOwner ? (<button
              ...
              onClick={(e) =>
                router.push(`/agent-details/${customer_slug_id}/${(isProject && is_admin_listing === 1) || added_by === 0 ? `?is_admin=true&lang=${lang}` : `?lang=${lang}`}`)
              }
            >
              {t("viewListing")}
