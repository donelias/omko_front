...
import { isRTL, decodeBase64FilterUrl, generateBase64FilterUrl, getPostedSince, getPostedSinceString, buildPropertyApiParams } from "@/utils/helperFunction";
...
const Search = () => {
  ...
  const handleFilterApply = useCallback((newFilters) => {
    ...
    const base64Filters = generateBase64FilterUrl(newFilters, options);
