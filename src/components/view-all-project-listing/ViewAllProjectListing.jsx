...
const ViewAllProjectListing = () => {
  ...
  const handleFilterApply = (newFilters) => {
    ...
    try {
      ...
      const urlStr = encodedUrlFilters
        ? `/projects/${slug}?filters=${encodedUrlFilters}&lang=${lang}`
        : `/projects/${slug}?lang=${lang}`;
  ...
  const handleClearFilter = () => {
    ...
    // Navigate to clean URL — the URL change will trigger initializeFiltersFromQuery → setFilters → fetch
    router?.push(`/projects/${slug}?lang=${lang}`);
  };
