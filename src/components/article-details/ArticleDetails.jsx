...
const ArticleDetails = () => {
  ...
  const currentUrl = `${process.env.NEXT_PUBLIC_WEB_URL}${router?.asPath?.split("?")[0]}?share=true&lang=${lang}`;
  ...
  const handleCategorySelect = (categoryId) => {
    ...
    router.push(`/all/articles?lang=${lang}`);
  };
    ...
    <div>
      ...
      <div className="container mx-auto px-4 my-10">
        ...
        <div className="grid grid-cols-12 gap-4">
          <div className="col-span-12 md:col-span-8 lg:col-span-9 h-max">
            <ImageWithPlaceholder
              src={article?.image}
              alt={article?.title}
              className="h-[186px] md:h-full aspect-[300/186] lg:aspect-[1216/635] w-full rounded-lg md:rounded-2xl object-cover"
              loading="lazy"
            />
      ...
      <div className="primaryBackgroundBg mx-auto px-4 py-6">
        <div className="container">
          ...
          >
            ...
            <div className="mt-6 flex justify-center gap-6">
              <CarouselPrevious className="relative left-0 right-0 h-10 w-10 translate-y-0 border-none bg-white !shadow-none hover:bg-gray-100 hover:text-gray-900 rtl:rotate-180" />
              <CarouselDots />
              <CarouselNext className="relative left-0 right-0 h-10 w-10 translate-y-0 border-none bg-white !shadow-none hover:bg-gray-100 hover:text-gray-900 rtl:rotate-180" />
            </div>
          </Carousel>
        </div>
      </div>
