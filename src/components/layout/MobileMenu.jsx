        ...
        >
          ...
          <div>
            <div className="flex items-center justify-between border-b p-3 md:p-4">
              <div className="h-16 w-36 flex items-center">
            ...
            <ul className="flex flex-col ">
              ...
              <li
                ...
                onClick={() =>
                  handleMenuClick("contactUs", `/contact-us`)
                }
              >
                {t("contactUs")}
              </li>
              <li
                ...
                onClick={() => handleMenuClick("aboutUs", `/about-us`)}
              >
                {t("aboutUs")}
              </li>
              <li
                ...
                <React.Fragment>
                  ...
                  >
                    <li
                      ...
                      onClick={() =>
                        handleMenuClick(isAgent ? "dashboard" : "myProfile", `/user/${isAgent ? "dashboard" : "profile"}`)
                      }
                    >
