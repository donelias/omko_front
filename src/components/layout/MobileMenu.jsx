    ...
    <>
      <Sheet open={isMenuOpen} onOpenChange={toggleMenu}>
        <SheetTrigger asChild>
          <button className="xl:hidden" aria-label="MobileMenuToggler" aria-expanded={isMenuOpen} aria-controls="mobile-menu">
            <GiHamburgerMenu
              size={30}
                  ...
                  >
                    {menu.links.map((link) => (
                      <li
                        ...
                        aria-current={activeMenu === link.name ? "page" : undefined}
                        onClick={() => {
