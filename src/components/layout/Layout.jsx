...
const Layout = ({ children }) => {
  ...
  // Hydration-safe: the loader only kicks in after mount (hasMounted). During
  // SSR and the first client render we output the real content so search
  // engines index it and React has nothing to mismatch on; the client then
  // applies its normal loading UX for initial load and route changes.
