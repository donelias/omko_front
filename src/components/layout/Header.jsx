              ...
              <div className="flex items-center gap-6">
                <Link href={`/?lang=${lang || "en"}`} title="Home">
                  ...
                  <ImageWithPlaceholder
                    ...
                    width={250}
                    height={80}
                    className="w-60 h-20 aspect-[250/80] object-contain"
                    priority={true}
                  />
                  {/* </div> */}
                </Link>
              ...
              <div className="flex items-center gap-6">
                ...
                <ul className="hidden items-center gap-4 xl:flex">
                  ...
                  >
                    ...
                    } className={router.pathname.includes('/about-us') ? 'primaryColor font-bold' : ''}>
                      {t("aboutUs")}
                    </span>
                  ...
                  >
                    ...
                    } className={router.pathname.includes('/contact-us') ? 'primaryColor font-bold' : ''}>
                      {t("contactUs")}
                    </span>
                              ...
                              <button
                                ...
                                onClick={(e) => {
                                  ...
                                  handleNavigateLinks(e, {
                                    route: isAgent ? `/user/dashboard` : `/user/profile`,
                                  });
                                  setOpenMenu(null);
                                }}
                              >
