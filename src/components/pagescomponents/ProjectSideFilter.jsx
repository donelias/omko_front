...
const ProjectSideFilter = ({
  ...
  useEffect(() => {
    if (currentFilters) {
      ...
      setMostViewed(currentFilters.most_viewed == "1" || false);
      setMostLiked(currentFilters.most_liked == "1" || false);
  ...
  const hasAnyFilterApplied = () => {
    ...
    const slugBasedRoutes = [
      "featured-projects",
      "most-viewed-projects",
      "most-favourite-projects",
    ];
    const isSlugBasedRoute = slugBasedRoutes.includes(hideFilterType);
    ...
    if (isSlugBasedRoute) {
      return hasCommonFilters;
    }

    return hasCommonFilters || isFeatured || isPremium || mostViewed || mostLiked;
  };
  ...
  const handleClearFilterClick = () => {
    ...
    setMostViewed(false);
    setMostLiked(false);
    if (hideFilter && hideFilterType === "featured-projects") {
      setIsFeatured(false);
    }
    if (hideFilter && hideFilterType === "most-viewed-projects") {
      setMostViewed(false);
    }
    if (hideFilter && hideFilterType === "most-favourite-projects") {
      setMostLiked(false);
    }
  };
    ...
    >
      ...
      <div className="flex-grow overflow-y-auto">
        ...
        <div className="border-t">
          {/* Featured Project */}
          {!(hideFilter && hideFilterType === "featured-projects") ? (
            <div className="flex min-h-[62px] items-center justify-between border-b p-3 sm:p-4">
              ...
              <Switch
                ...
                disabled={slug === "featured-projects"}
              />
            </div>
          ) : null}
