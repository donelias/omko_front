                                ...
                                <div className="flex flex-col w-full lg:flex-1">
                                    ...
                                    <div className="flex items-center">
                                        <Switch
                                            ...
                                            className={`${propertyFormData.isPremiumProperty ? "!primaryBg" : ""}  sm:[&>span]:h-3 sm:[&>span]:w-3 ${isRtl ? "sm:data-[state=checked]:[&>span]:-translate-x-5" : "sm:data-[state=checked]:[&>span]:translate-x-5"}`}
                                        />
                                    </div>
