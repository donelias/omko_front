        ...
        <div className="flex flex-col gap-8">
            {webSettings?.gemini_ai_enabled === true ? (
                <div className='flex justify-center md:justify-start'>
                    ...
                    >
                        <RiSparkling2Fill className='primaryColor w-5 h-5' /> <span className='break-all'>{isMetaDataGenerating ? t("generating") : t("generateWithAI")}</span>
                    </button>
                </div>
            ) : null}
            ...
            <div className="flex justify-end gap-3 flex-wrap">
                {handleSaveAsDraft ? (
                    <Button
                        ...
                        disabled={showLoader}
                    >
                        {showLoader ? t("loading") : t("saveAsDraft")}
                    </Button>
                ) : null}
                <Button
                    type="button"
                ...
                >
                    {showLoader ? (
                        ...
                        submitButtonText || (isProperty && isEditing ? t("updateProperty") : isProperty && !isEditing ? t("submitProperty") : !isProperty && isEditing ? t("updateProject") : t("submitProject"))
                    )}
                </Button>
            </div>
        </div>
