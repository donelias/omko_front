        ...
        <div className="dropdown-content absolute right-[-30px] md:right-0 rtl:-right-[150px] md:rtl:-right-[220px] xl:rtl:-right-[120px] top-full z-50 mt-3 min-w-[250px] w-full md:min-w-[300px] rounded-b-2xl bg-white shadow-[0_10px_40px_rgba(0,0,0,0.1)] border border-gray-100 overflow-hidden">
            ...
            {showSwitchToAgentButton ? (
                <div className="px-3 md:px-4 pb-3 md:pb-4 border-b newBorderColor">
                    <button className="w-full border leadBorder rounded-lg py-1 md:py-2 font-bold secondaryTextColor" onClick={handleSwitchToAgentClick}>
                        {t("switchToAgent")}
                    </button>
                </div>) : null}
            ...
            {isMobileAndTabletScreen && isAgentVerificationNotApplied && !isBecomeAgentPage ? (
                <div className="px-3 md:px-4 pb-3 md:pb-4 border-b newBorderColor">
                    <button className="w-full flex justify-center items-center gap-2 border leadBorder rounded-lg py-2 md:py-2 font-bold secondaryTextColor hover:brandBg hover:text-white" onClick={handleSwitchToAgentClick}>
                ...
                (
                    <div className="px-3 md:px-4 pb-3 md:pb-4 border-b newBorderColor">
                        <button className="w-full flex justify-center items-center gap-2 border leadBorder rounded-lg py-2 md:py-2 font-bold secondaryTextColor hover:brandBg hover:text-white" onClick={() => router?.push(`/become-agent/?lang=${lang}`)}>
