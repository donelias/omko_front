            ...
            <div className='container py-5 px-5 md:py-12 lg:py-[60px]'>
                <div className='grid grid-cols-1 lg:grid-cols-12 gap-8'>
                    <div className='flex flex-col col-span-6 gap-8'>
                        <h2 className='text-xl lg:text-2xl xl:text-[32px] text-left font-bold col-span-6 rtl:text-right'>{translated_title || title}</h2>
                        <p className='col-span-6 secondaryTextColor text-left rtl:text-right'>{t("faqDescription")}</p>
