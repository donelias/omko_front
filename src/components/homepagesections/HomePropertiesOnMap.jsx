            ...
            <div className="container mx-auto px-4 py-6 sm:py-6 md:py-12 lg:py-[60px]">
                ...
                <div className="flex flex-col gap-6 md:gap-12">
                    ...
                    <div className="w-full min-h-[400px] md:h-[600px] rounded-2xl overflow-hidden relative shadow-lg"
                        ...
                        {!isMapInteractive && (
                            <div
                                className="absolute inset-0 z-10 cursor-pointer flex items-center justify-center text-sm text-white/80 bg-black/10 backdrop-blur-[2px] p-4 text-center"
                                title={t("clickToActivateMap")}
                            >
