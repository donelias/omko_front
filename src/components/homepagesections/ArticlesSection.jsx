    ...
    return (
        ...
        <div className="grid grid-cols-12 gap-4">
            ...
            <CustomLink
                ...
                className="relative col-span-12 md:col-span-6 rounded-2xl overflow-hidden flex flex-col justify-end shadow-lg cursor-pointer h-[424px] md:h-full"
            >
                {/* Article Image */}
                    ...
                    <div className="flex items-center gap-2">
                        {webSettings?.admin_image && (
                            <ImageWithPlaceholder
                                ...
                                className="w-8 h-8 rounded-full object-cover cardBorder"
                                loading='lazy'
                            />
                        )}
            ...
            <div className="col-span-12 md:col-span-6 flex flex-col gap-4">
                {smallCards.map((article, idx) => (
                    <CustomLink
                        ...
                        className="relative flex flex-col lg:flex-row md:gap-6 cursor-pointer bg-white"
                    >
                        {/* Article Image */}
                        <ImageWithPlaceholder
                            src={article?.image}
                            alt={article?.translated_title || article?.title}
                            className="w-full h-full md:w-[280px] md:h-[200px] rounded-2xl object-cover"
                            loading='lazy'
                        />
                        {/* Content */}
