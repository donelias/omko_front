...
const MobileBottomSheet = ({ isOpen = true }) => {
    ...
    const appName = settings?.company_name || 'omko';

    const appScheme = settings?.schema_for_deeplink || 'omko';
                    ...
                    <div className="p-6">
                        ...
                        <div className="flex items-center mb-6">
                            ...
                            <div className="flex-1">
                                <h4 className="text-lg font-bold secondaryTextColor mb-1">
                                    {appName}
                                </h4>
                        ...
                        <div className="flex gap-3">
                            ...
                            <button
                                className="flex-1 bg-gray-100 secondaryTextColor rounded-lg py-3 px-4 font-semibold text-base transition-colors hover:bg-gray-200"
                                onClick={handleClose}
                            >
                                {t("cancel")}
                            </button>
            ...
            {showAppNotInstalledPopup && (
                <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4">
                    ...
                    <div className="relative cardBg rounded-2xl p-6 max-w-sm w-full shadow-xl">
                        <h3 className="text-lg font-bold secondaryTextColor mb-3">
