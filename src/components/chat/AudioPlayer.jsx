  ...
  return (
    <div className="flex w-full items-center rounded-full bg-gray-100">
      ...
      <button
        type="button"
        onClick={handleMute}
        className="secondaryTextColor mx-1 flex h-4 items-center justify-center md:mx-2 md:my-2 md:h-8 md:w-8"
      ...
      <DropdownMenu>
        <DropdownMenuTrigger asChild>
          <button
            type="button"
            className="secondaryTextColor flex h-6 w-6 items-center justify-center md:h-8 md:w-8"
          >
