import { formatTimeDifference, VerifiedAgentBadge, VerifiedUserBadge } from "@/utils/helperFunction";
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  <h3 className="text-sm font-medium flex items-center gap-1">
                    {conversation?.name}
                    {/* {isUserChat && conversation?.is_user_verified ? (
                      <VerifiedUserBadge color={webSettings?.system_color} width={14} height={14} />
                    ) : conversation?.is_agent_verified && (
