            ...
            <DialogContent className="[&>button]:hidden p-0">
                ...
                <div className="space-y-6 p-4">
                    <div>
                        ...
                        <p className="text-left text-base font-light secondaryTextColor">{t("desiredUnits")}</p>
                    </div>
                    ...
                    <div className="flex flex-col md:flex-row md:items-end gap-4">
                        <div className="w-full md:w-2/3 space-y-2">
                            ...
                            <div className="flex gap-2">
                                ...
                                <Select value={fromUnit} onValueChange={handleFromUnitChange}>
                                    <SelectTrigger className="w-full primaryBackgroundBg secondaryTextColor h-[5vh] sm:min-w-[120px] outline-none focus:ring-0 text-sm md:text-base" id="from-unit">
                        ...
                        <div className="w-full md:w-1/3 space-y-2">
                            ...
                            <Select value={toUnit} onValueChange={handleToUnitChange}>
                                <SelectTrigger className="w-full primaryBackgroundBg secondaryTextColor h-[5vh] sm:min-w-[120px] outline-none focus:ring-0 text-sm md:text-base" id="to-unit">
                    ...
                    {convertedValue && (
                        <motion.div
                            ...
                            className="p-4 rounded-md text-xl bg-teal-50 border primaryBorderColor text-center primaryBgLight08 primaryColor"
                        >
