...
export const createAllPaymentIntentApi = async ({
  ...
  const formData = createFilteredFormData({ package_id, platform_type, payment_method });
...
// ============================================
// 113-128: COMMISSION SYSTEM API (v1.3.0)
// ============================================
...
export const getCommissionsApi = async ({
  ...
  const res = await api.get(apiEndpoints.GET_COMMISSIONS, { params });
  return res.data;
};

// 114. Create Commission
export const createCommissionApi = async ({
  property_id = "",
  agent_user_id = "",
  buyer_user_id = null,
  seller_user_id = null,
  ...
  const res = await api.post(apiEndpoints.CREATE_COMMISSION, formData);
  return res.data;
};

// 115. Get Commission By ID
export const getCommissionByIdApi = async (id) => {
  const url = apiEndpoints.GET_COMMISSION_BY_ID.replace("{id}", id);
  const res = await api.get(url);
  return res.data;
};

// 116. Approve Commission
export const approveCommissionApi = async ({
  id = "",
  notes = ""
} = {}) => {
  const url = apiEndpoints.APPROVE_COMMISSION.replace("{id}", id);
  const formData = createFilteredFormData({ notes });
  const res = await api.post(url, formData);
  return res.data;
};

// 117. Reject Commission
export const rejectCommissionApi = async ({
  id = "",
  reason = ""
} = {}) => {
  const url = apiEndpoints.REJECT_COMMISSION.replace("{id}", id);
  const formData = createFilteredFormData({ reason });
  const res = await api.post(url, formData);
  return res.data;
};

// 118. Record Commission Payment
export const recordCommissionPaymentApi = async ({
  ...
  const url = apiEndpoints.RECORD_COMMISSION_PAYMENT.replace("{id}", id);
  const formData = createFilteredFormData({
    amount,
    method,
    reference,
...
// 119. Get Agent Commission Dashboard
export const getAgentCommissionDashboardApi = async () => {
  const res = await api.get(apiEndpoints.GET_AGENT_COMMISSION_DASHBOARD);
  return res.data;
};

// 120. Get Pending Commissions
export const getPendingCommissionsApi = async ({
  per_page = 10,
  page = 1
} = {}) => {
  const params = getFilteredParams({ per_page, page });
  const res = await api.get(apiEndpoints.GET_PENDING_COMMISSIONS, { params });
  return res.data;
};

// 121. Get Commission Alerts
export const getCommissionAlertsApi = async ({
  per_page = 10,
  page = 1
} = {}) => {
  const params = getFilteredParams({ per_page, page });
  const res = await api.get(apiEndpoints.GET_COMMISSION_ALERTS, { params });
  return res.data;
};

// 122. Mark Alert as Read
export const markAlertAsReadApi = async (id) => {
  const url = apiEndpoints.MARK_ALERT_AS_READ.replace("{id}", id);
  const res = await api.post(url);
  return res.data;
};

// 123. Generate Commission Report
export const generateCommissionReportApi = async ({
  start_date = "",
  end_date = "",
  agent_id = "",
  format = "pdf"
  ...
  const res = await api.get(apiEndpoints.GENERATE_COMMISSION_REPORT, { params });
  return res.data;
};

// 124. Get Commission Settings
export const getCommissionSettingsApi = async () => {
  const res = await api.get(apiEndpoints.GET_COMMISSION_SETTINGS);
  return res.data;
};

// 125. Update Commission Settings
export const updateCommissionSettingsApi = async ({
  commission_rate = "",
  ...
  const res = await api.post(apiEndpoints.UPDATE_COMMISSION_SETTINGS, formData);
  return res.data;
};

// 126. Validate Transaction Commission
export const validateTransactionCommissionApi = async ({
  property_id = "",
  transaction_type = "sale",
  agent_user_id = ""
} = {}) => {
  ...
  const res = await api.post(apiEndpoints.VALIDATE_TRANSACTION_COMMISSION, formData);
  return res.data;
};

// 127. Get Commission History
export const getCommissionHistoryApi = async (id) => {
  const url = apiEndpoints.GET_COMMISSION_HISTORY.replace("{id}", id);
  const res = await api.get(url);
  return res.data;
};

// 128. Get Commission Payment Logs
export const getCommissionPaymentLogsApi = async (id) => {
  const url = apiEndpoints.GET_COMMISSION_PAYMENT_LOGS.replace("{id}", id);
  const res = await api.get(url);
  return res.data;
};

// ============================================
// 129-135: PRICE INTELLIGENCE API (v1.3.0)
// ============================================

// 129. Get Price Suggestion
export const getPriceSuggestionApi = async ({
  propertyId = "",
  force_refresh = false
} = {}) => {
  const url = apiEndpoints.GET_PRICE_SUGGESTION.replace("{propertyId}", propertyId);
  const params = getFilteredParams({ force_refresh });
  const res = await api.get(url, { params });
  return res.data;
};

// 130. Get Price Analysis
export const getPriceAnalysisApi = async ({
  propertyId = "",
  include_comparables = true
} = {}) => {
  const url = apiEndpoints.GET_PRICE_ANALYSIS.replace("{propertyId}", propertyId);
  const params = getFilteredParams({ include_comparables });
  const res = await api.get(url, { params });
  return res.data;
};

// 131. Get Market Analysis
export const getMarketAnalysisApi = async ({
  city = "",
  category = "",
  radius = 5
} = {}) => {
  const params = getFilteredParams({ city, category, radius });
  const res = await api.post(apiEndpoints.GET_MARKET_ANALYSIS, { ...params });
  return res.data;
};

// 132. Record Price History
export const recordPriceHistoryApi = async ({
  ...
  const res = await api.post(apiEndpoints.RECORD_PRICE_HISTORY, formData);
  return res.data;
};

// 133. Get Bulk Suggestions
export const getBulkSuggestionsApi = async ({
  property_ids = [],
  force_refresh = false
} = {}) => {
  const formData = createFilteredFormData({
    property_ids: property_ids.join(","),
    force_refresh
  });
  const res = await api.post(apiEndpoints.GET_BULK_SUGGESTIONS, formData);
  return res.data;
};

// 134. Get Comparable Properties
export const getComparablePropertiesApi = async ({
  propertyId = "",
  limit = 10
} = {}) => {
  const url = apiEndpoints.GET_COMPARABLE_PROPERTIES.replace("{propertyId}", propertyId);
  const params = getFilteredParams({ limit });
  const res = await api.get(url, { params });
  return res.data;
};

// 135. Get Price Trends
export const getPriceTrendsApi = async ({
  city = "",
  category = "",
  period = "monthly"
} = {}) => {
  const params = getFilteredParams({ city, category, period });
  const res = await api.get(apiEndpoints.GET_PRICE_TRENDS, { params });
  return res.data;
};

// ============================================
// 136-150: CRM SYSTEM API (v1.3.0)
// ============================================

// 136. Get CRM Leads
export const getCrmLeadsApi = async ({
  status = "",
  agent_id = "",
  campaign_id = "",
  origin = "",
  ...
  const res = await api.get(apiEndpoints.GET_CRM_LEADS, { params });
  return res.data;
};

// 137. Create CRM Lead
export const createCrmLeadApi = async ({
  nombre = "",
  email = "",
  telefono = "",
  property_id = "",
  ...
  const res = await api.post(apiEndpoints.CREATE_CRM_LEAD, formData);
  return res.data;
};

// 138. Get CRM Lead By ID
export const getCrmLeadByIdApi = async (id) => {
  const url = apiEndpoints.GET_CRM_LEAD_BY_ID.replace("{id}", id);
  const res = await api.get(url);
  return res.data;
};

// 139. Update CRM Lead
export const updateCrmLeadApi = async ({
  id = "",
  nombre = "",
  email = "",
  telefono = "",
  ...
  const url = apiEndpoints.UPDATE_CRM_LEAD.replace("{id}", id);
  const formData = createFilteredFormData({
    nombre,
    email,
    telefono,
...
// 140. Delete CRM Lead
export const deleteCrmLeadApi = async (id) => {
  const url = apiEndpoints.DELETE_CRM_LEAD.replace("{id}", id);
  const res = await api.delete(url);
  return res.data;
};

// 141. Get CRM Interactions
export const getCrmInteractionsApi = async ({
  lead_id = "",
  per_page = 20,
  page = 1
} = {}) => {
  const params = getFilteredParams({ lead_id, per_page, page });
  const res = await api.get(apiEndpoints.GET_CRM_INTERACTIONS, { params });
  return res.data;
};

// 142. Create CRM Interaction
export const createCrmInteractionApi = async ({
  lead_id = "",
  interaction_type = "",
  description = "",
  notes = ""
  ...
  const res = await api.post(apiEndpoints.CREATE_CRM_INTERACTION, formData);
  return res.data;
};

// 143. Get CRM Campaigns
export const getCrmCampaignsApi = async ({
  status = "",
  per_page = 15,
  page = 1
} = {}) => {
  const params = getFilteredParams({ status, per_page, page });
  const res = await api.get(apiEndpoints.GET_CRM_CAMPAIGNS, { params });
  return res.data;
};

// 144. Create CRM Campaign
export const createCrmCampaignApi = async ({
  name = "",
  description = "",
  start_date = "",
  end_date = "",
  ...
  const res = await api.post(apiEndpoints.CREATE_CRM_CAMPAIGN, formData);
  return res.data;
};

// 145. Get Lead Scoring
export const getLeadScoringApi = async (leadId) => {
  const url = apiEndpoints.GET_LEAD_SCORING.replace("{leadId}", leadId);
  const res = await api.get(url);
  return res.data;
};

// 146. Update Lead Scoring
export const updateLeadScoringApi = async ({
  leadId = "",
  score = "",
  reason = ""
} = {}) => {
  const url = apiEndpoints.UPDATE_LEAD_SCORING.replace("{leadId}", leadId);
  const formData = createFilteredFormData({ score, reason });
  const res = await api.put(url, formData);
  return res.data;
};

// 147. Sync CRM with Meta
export const syncCrmWithMetaApi = async () => {
  const res = await api.post(apiEndpoints.SYNC_CRM_META);
  return res.data;
};

// 148. Get CRM Dashboard
export const getCrmDashboardApi = async () => {
  const res = await api.get(apiEndpoints.GET_CRM_DASHBOARD);
  return res.data;
};

// 149. Export CRM Data
export const exportCrmDataApi = async ({
  format = "excel",
  start_date = "",
  end_date = ""
} = {}) => {
  const params = getFilteredParams({ format, start_date, end_date });
  const res = await api.get(apiEndpoints.EXPORT_CRM_DATA, { params });
  return res.data;
};

// ============================================
// 151-165: META & WHATSAPP INTEGRATION (v1.3.0)
// ============================================

// 151. Get Meta Credentials
export const getMetaCredentialsApi = async () => {
  const res = await api.get(apiEndpoints.GET_META_CREDENTIALS);
  return res.data;
};

// 152. Create Meta Credential
export const createMetaCredentialApi = async ({
  meta_app_id = "",
  meta_app_secret = "",
  meta_access_token = "",
  ...
  const res = await api.post(apiEndpoints.CREATE_META_CREDENTIAL, formData);
  return res.data;
};

// 153. Get Meta Credential By ID
export const getMetaCredentialByIdApi = async (id) => {
  const url = apiEndpoints.GET_META_CREDENTIAL_BY_ID.replace("{id}", id);
  const res = await api.get(url);
  return res.data;
};

// 154. Update Meta Credential
export const updateMetaCredentialApi = async ({
  id = "",
  meta_access_token = "",
  fecha_expiracion_token = ""
} = {}) => {
  const url = apiEndpoints.UPDATE_META_CREDENTIAL.replace("{id}", id);
  const formData = createFilteredFormData({
    meta_access_token,
    fecha_expiracion_token
  });
...
// 155. Delete Meta Credential
export const deleteMetaCredentialApi = async (id) => {
  const url = apiEndpoints.DELETE_META_CREDENTIAL.replace("{id}", id);
  const res = await api.delete(url);
  return res.data;
};

// 156. Renew Meta Token
export const renewMetaTokenApi = async (id) => {
  const url = apiEndpoints.RENEW_META_TOKEN.replace("{id}", id);
  const res = await api.post(url);
  return res.data;
};

// 157. Deactivate Meta Credential
export const deactivateMetaCredentialApi = async (id) => {
  const url = apiEndpoints.DEACTIVATE_META_CREDENTIAL.replace("{id}", id);
  const res = await api.post(url);
  return res.data;
};

// 158. Get WhatsApp Credentials
export const getWhatsAppCredentialsApi = async () => {
  const res = await api.get(apiEndpoints.GET_WHATSAPP_CREDENTIALS);
  return res.data;
};

// 159. Create WhatsApp Credential
export const createWhatsAppCredentialApi = async ({
  phone_number_id = "",
  business_account_id = "",
  access_token = "",
  phone_number = "",
  ...
  const res = await api.post(apiEndpoints.CREATE_WHATSAPP_CREDENTIAL, formData);
  return res.data;
};

// 160. Get WhatsApp Credential By ID
export const getWhatsAppCredentialByIdApi = async (id) => {
  const url = apiEndpoints.GET_WHATSAPP_CREDENTIAL_BY_ID.replace("{id}", id);
  const res = await api.get(url);
  return res.data;
};

// 161. Update WhatsApp Credential
export const updateWhatsAppCredentialApi = async ({
  id = "",
  nombre_cuenta = "",
  fecha_expiracion_token = ""
} = {}) => {
  const url = apiEndpoints.UPDATE_WHATSAPP_CREDENTIAL.replace("{id}", id);
  const formData = createFilteredFormData({
    nombre_cuenta,
    fecha_expiracion_token
  });
...
// 162. Delete WhatsApp Credential
export const deleteWhatsAppCredentialApi = async (id) => {
  const url = apiEndpoints.DELETE_WHATSAPP_CREDENTIAL.replace("{id}", id);
  const res = await api.delete(url);
  return res.data;
};

// 163. Renew WhatsApp Token
export const renewWhatsAppTokenApi = async (id) => {
  const url = apiEndpoints.RENEW_WHATSAPP_TOKEN.replace("{id}", id);
  const res = await api.post(url);
  return res.data;
};

// 164. Deactivate WhatsApp Credential
export const deactivateWhatsAppCredentialApi = async (id) => {
  const url = apiEndpoints.DEACTIVATE_WHATSAPP_CREDENTIAL.replace("{id}", id);
  const res = await api.post(url);
  return res.data;
};

// 165. Get Meta Sync Logs
export const getMetaSyncLogsApi = async ({
  per_page = 20,
  page = 1
} = {}) => {
  const params = getFilteredParams({ per_page, page });
  const res = await api.get(apiEndpoints.GET_META_LOGS, { params });
  return res.data;
};

// 166. Sync Meta Leads Manually
export const syncMetaLeadsManuallyApi = async () => {
  const res = await api.post(apiEndpoints.META_SYNC_LEADS);
  return res.data;
};

// 167. Create Meta Campaign
export const createMetaCampaignApi = async ({
  name = "",
  description = "",
  start_date = "",
  end_date = "",
  ...
  const res = await api.post(apiEndpoints.CREATE_META_CAMPAIGN, formData);
  return res.data;
};

// 168. Get Meta Campaign Leads
export const getMetaCampaignLeadsApi = async (campaignId) => {
  const url = apiEndpoints.GET_META_CAMPAIGN_LEADS.replace("{id}", campaignId);
  const res = await api.get(url);
  return res.data;
};

// 169. Send Meta Message
export const sendMetaMessageApi = async ({
  recipient_id = "",
  message_text = ""
} = {}) => {
  const formData = createFilteredFormData({
  ...
  const res = await api.post(apiEndpoints.SEND_META_MESSAGE, formData);
  return res.data;
};

// 170. Get All Credentials (Admin)
export const getAllCredentialsApi = async () => {
  const res = await api.get(apiEndpoints.GET_ALL_CREDENTIALS);
  return res.data;
};

// 171. Get Expiring Credentials (Admin)
export const getExpiringCredentialsApi = async () => {
  const res = await api.get(apiEndpoints.GET_EXPIRING_CREDENTIALS);
  return res.data;
};

// 150. Import CRM Data
export const importCrmDataApi = async ({
  file = null
} = {}) => {
  const formData = new FormData();
  if (file) formData.append("file", file);
  const res = await api.post(apiEndpoints.IMPORT_CRM_DATA, formData);
  return res.data;
};