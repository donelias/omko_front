...
import { generateAIPropertyDescriptionApi, generateAIPropertyMetaDataApi, getCategoriesApi, getFacilitiesApi, postPropertyApi } from '@/api/apiRoutes';
...
const AddProperty = () => {
    ...
    const handleTabChange = (value) => {
        const tabOrder = ["categories", "propertyDetails", "seoSettings", "facilities", "outdoorFacilities", "location", "imagesVideo"];
