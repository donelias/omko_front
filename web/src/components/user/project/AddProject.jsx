...
import { generateAIPropertyDescriptionApi, generateAIPropertyMetaDataApi, getCategoriesApi, postProjectApi } from '@/api/apiRoutes'
...
const AddProject = () => {
    ...
    const handleTabChange = (value) => {
        const tabOrder = ["categories", "projectDetails", "seoSettings", "location", "floorDetails", "imagesVideo"];
        ...
        try {
            ...
            if (!response?.error) {
                Swal.fire({
                    ...
                    router.push(`/user/projects/?lang=${lang}`);
                });
            } else {
