          ...
          {aboveBreadCrumbAdBanner && (
            ...
            >
              <ImageWithPlaceholder
                ...
                alt="Ad Banner"
                className={`w-full object-cover h-[350px] ${aboveBreadCrumbAdBanner?.external_link_url || aboveBreadCrumbAdBanner?.property?.slug_id ? 'cursor-pointer' : ''}`}
              ...
              {belowMortgageAdBanner && (
                ...
                >
                  ...
                  <ImageWithPlaceholder
                    ...
                    alt="Ad Banner"
                    className={`w-full object-cover h-[587px] ${belowMortgageAdBanner?.external_link_url || belowMortgageAdBanner?.property?.slug_id ? 'cursor-pointer' : ''}`}
          ...
          {aboveSimilarPropertiesAdBanner && (
            ...
            >
              <ImageWithPlaceholder
                ...
                className={`w-full h-[350px] object-cover ${aboveSimilarPropertiesAdBanner?.external_link_url || aboveSimilarPropertiesAdBanner?.property?.slug_id ? 'cursor-pointer' : ''}`}
                imageClassName="rounded-lg lg:rounded-2xl"
