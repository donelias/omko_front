            ...
            <div className="container mx-auto px-4 md:px-0 py-6 md:py-10 lg:py-[60px]">
                <div className="flex flex-col gap-6 md:gap-12">
                        ...
                        >
                            ...
                            {buttonText && buttonLink && data.length > 4 && (
                                <div className="mt-10 md:hidden text-center">
                                    <CustomLink href={buttonLink + (passLocationFilter ? getLocationLatLngFilter("1") : "")} className="inline-flex items-center gap-2 px-4 py-2 md:px-4 md:py-3 border border-black rounded-md text-black font-medium hover:brandBg hover:text-white transition-colors duration-200">
                                        {t(buttonText)}
                    ...
                    {displayData.length === 2 && (
                        ...
                        <div className="hidden lg:grid grid-cols-2 gap-6 max-w-4xl w-full mx-auto">
