...
const PropertyVerticalCard = ({
  ...
  return (
    <div
      dir={isRtl ? "rtl" : "ltr"}
      className="newBorderColor group flex flex-col min-h-[452px] overflow-hidden w-full md:max-w-full rounded-2xl border bg-white transition-shadow duration-300 hover:cursor-pointer hover:cardHoverShadow"
      ...
      <div className="flex flex-grow flex-col">
        ...
        >
          <div className="flex flex-wrap items-center justify-center break-words gap-0.5">
            ...
            <span className="text-sm leading-none truncate font-normal">{property?.property_type === "rent" && property?.rentduration ? "/ " + property?.rentduration : ""}</span>
          </div>
          {property.is_premium ? (
