...
const MetaData = ({
  ...
  ogUrl = process.env.NEXT_PUBLIC_SEO === "true" ? `${process.env.NEXT_PUBLIC_WEB_URL}${pageName}` : null,
  ...
  const safeTitle = title || process.env.NEXT_PUBLIC_META_TITLE || 'eBroker';
  ...
  const safeAuthor = author || process.env.NEXT_PUBLIC_APP_NAME || 'eBroker';
  ...
  const safeSiteName = siteName || process.env.NEXT_PUBLIC_META_TITLE || 'eBroker';
