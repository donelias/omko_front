...
const api = ({ dispatch, getState }) => (next) => async (action) => {
    ...
    try {
        ...
        // For FormData, axios needs to handle it automatically
        // Don't set Content-Type header, let axios/browser detect it
        if (data instanceof FormData) {
            // Remove Content-Type header to let browser set multipart/form-data automatically
