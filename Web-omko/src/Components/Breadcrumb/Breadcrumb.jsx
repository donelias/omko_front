...
const Breadcrumb = (props) => {
    ...
    useSelector((state) => state.Language?.currentLanguageCode || 'en');
                            ...
                            <div className="col-12 col-md-6 col-lg-6">
                                <div className="left-side-content">
                                    ...
                                    <div className="prop-sell-time">
                                        <span className={`${data.propertyType === "sell" ? "propertie-sell-tag" : "propertie-rent-tag"}`}>{translate(data.propertyType)}</span>
                                        <span>
                                            {" "}
