...
import { GetAllCategorieApi, GetFacilitiesApi, UpdatePostProperty, getAddedPropertiesApi } from "@/store/actions/campaign";
                                        ...
                                        <>
                                            ...
                                            {tab2[ele?.id] && (
                                                <p id={`selected-file-name_${ele?.id}`}>
                                                    Selected File: {typeof tab2[ele?.id] === "string"
                                                        ? tab2[ele?.id].split('/').pop()
                                                        : tab2[ele?.id]?.name}
                                                </p>
                                            )}
