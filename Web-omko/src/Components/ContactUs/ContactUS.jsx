                                        ...
                                        <div className="row">
                                            <div className="col-sm-12 col-md-6">
                                                ...
                                                <div className="form-inputs">
                                                    ...
                                                    <input type="text" className="form-custom-input" name="firstName" placeholder={translate("enterFirstName")} value={formData.firstName} onChange={handleInputChange} />
                                                </div>
                                            </div>
                                            <div className="col-sm-12 col-md-6">
                                                {/* Last Name */}
                                                <div className="form-inputs">
                                                    ...
                                                    <input type="text" className="form-custom-input" name="lastName" placeholder={translate("enterLastName")} value={formData.lastName} onChange={handleInputChange} />
                                                </div>
                                            </div>
                                            <div className="col-sm-12 col-md-6">
                                                {/* Email */}
                                                <div className="form-inputs">
                                                    ...
                                                    <input type="text" className="form-custom-input" name="email" placeholder={translate("enterEmail")} value={formData.email} onChange={handleInputChange} />
                                                </div>
                                            </div>
                                            <div className="col-sm-12 col-md-6">
                                                {/* Subject */}
                                                <div className="form-inputs">
                                                    ...
                                                    <input type="text" className="form-custom-input" name="subject" placeholder={translate("enterSubject")} value={formData.subject} onChange={handleInputChange} />
                                                </div>
                                            </div>
                                            <div className="col-sm-12">
                                                ...
                                                <div className="form-inputs">
                                                    ...
                                                    <textarea rows={8} className="form-custom-input-textarea" name="message" placeholder={translate("enterMessage")} value={formData.message} onChange={handleInputChange} />
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div className="col-12" id="contactus-socialPlatforms">
                                                ...
                                                <div className="row">
                                                    ...
                                                    {systemsettings?.youtube_id ? (
                                                        <div className="col-sm-12 col-md-6 col-lg-3" id="social-platforms">
                                                            <a href={systemsettings?.youtube_id} target="_blank">
                                                                <button className="social-platforms-icons">
                                                                    <FaYoutube size={30} />
                                                                </button>
                                                            </a>
