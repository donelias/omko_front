                            ...
                            <div class="col-sm-12 mt-2">
                                <div class="col-md-12 col-12">
                                    <div class="form-group mandatory">
                                        ...
                                        <input type="text" id="edit_language_name" class="form-control col-12" placeholder="{{ __('Language Name') }}" name="edit_language_name" data-parsley-required="true">
                                    </div>
                                </div>
                            ...
                            <div class="col-sm-12 mt-2">
                                <div class="col-md-12 col-12">
                                    <div class="form-group mandatory">
                                        ...
                                        <input type="text" class="form-control col-12 edit_language_code" placeholder="{{ __('Language Code') }}" data-parsley-required="true" disabled>
