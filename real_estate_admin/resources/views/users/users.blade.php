                            ...
                            <div class="col-sm-4">
                                ...
                                <div class="col-md-12 col-12">
                                    <div class="form-group mandatory align-items-center">
                                        ...
                                        <input type="password" id="password" class="form-control col-12" placeholder="{{ __('Password') }}" minlength="8">
                            ...
                            <div class="col-sm-4">
                                ...
                                <div class="col-md-12 col-12">
                                    <div class="form-group mandatory">
                                        ...
                                        {!! Form::select('status', ['0' => trans('Inactive'), '1' => trans('Active')], '', [ 'class' => 'form-select', 'id' => 'status']) !!}
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group row align-items-center">
                                ...
                                <div class="col-lg-8 mb-3">
                                    <input type="password" class="form-control" name="newPassword" id="newPassword" placeholder="{{ __('New password') }}" minlength="8">
                            ...
                            <div class="form-group row align-items-center">
                                ...
                                <div class="col-lg-8 mb-3">
                                    <input type="password" class="form-control" name="confPassword" id="confPassword" placeholder="{{ __('Confirm password') }}" minlength="8">
                                    <span class="form-text text-muted"><small>{{ __('Min Password Length Must Be of 8') }}</small></span>
