...
const SubscriptionPlanPage = dynamic(
  () => import("@/components/pagescomponents/SubscriptionPlanPage"),
  { ssr: false },
);
...
const index = ({ seoData, pageName = "/subscription-plan/" }) => {
  return (
    <div>
      <MetaData
...
if (process.env.NEXT_PUBLIC_SEO === "true") {
  serverSidePropsFunction = async (context) => {
    ...
    const pageName = `/subscription-plan/?lang=${lang}`;
